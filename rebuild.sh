...
composer network install --card PeerAdmin@hlfv1 --archiveFile block-supply@0.0.6.bna

composer network upgrade --networkName block-supply --networkVersion 0.0.6 --card PeerAdmin@hlfv1
